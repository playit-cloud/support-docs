...
{{< image src="post-img/windows-create-txt-file.png" alt="papermc download" >}}
...
{{< image src="post-img/rename-to-run-bat.png" alt="rename to run.bat" >}}

{{< image src="post-img/confirm-rename.png" alt="confirm rename" >}}
...
{{< image src="post-img/windows-edit-bat-file.png" alt="confirm rename" >}}
...
{{< image src="post-img/windows-batch-file-type-good.png" alt="windows batch file ext good" >}}
{{< image src="post-img/windows-text-file-type-bad.png" alt="windows txt file ext bad" >}}
...
{{< image src="post-img/windows-file-explorer-view.png" alt="windows explorer view" >}}

Then make sure `File name extensions` is checked.

{{< image src="post-img/windows-explorer-view-file-ext.png" alt="view file name ext" >}}
