...
{{< image src="post-img/macos-system-pref-btn.png" alt="macos preference button" >}}

Next you'll want to find the button for editing `Network Pereferences`. You can search network to find this.

{{< image src="post-img/macos-network-settings.png" alt="macos network preference button" >}}

Select the network you're using and press `Advanced`.

{{< image src="post-img/macos-advanced-btn.png" alt="macos network advanced button" >}}
...
{{< image src="post-img/macos-set-dns.png" alt="macos set dns" >}}
