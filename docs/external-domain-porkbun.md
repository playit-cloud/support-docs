...
This guide assumes you have [playit premium](https://playit.gg/account/billing/shop/premium) and have purchased a domain name on [https://porkbun.com](porkbun.com). For other Domain Registars visit [Add an external domain to playit.gg](/add-external-domain).
...
![manage domain](/img/porkbun-manage-domain.png)
...
![edit nameservers](/img/porkbun-edit-nameservers.png)
...
![Porkbun add ns record](/img/porkbun-add-ns-record.png)
