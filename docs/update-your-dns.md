...
## Platform Guides
 - Windows: [Update your DNS server on Windows](/windows-update-dns)
 - MacOS: [Update your DNS server on MacOS](/macos-update-dns)
 - Linux: [Update your DNS server on Linux](/linux-update-dns)
