...
![ubuntu wired settings](/img/ubuntu-wired-settings.png)

Next press the gear icon next to the connection.

![ubuntu gear icon](/img/ubuntu-interface-settings.png)
...
![ubuntu dns settings](/img/ubuntu-set-dns.png)
...
![linux resolv conf warning](/img/linux-etc-resolv-conf.png)
