...
![linux bad run ubuntu](/img/linux-run-bad-ubuntu.png)
![linux bad run cli](/img/linux-run-bad-cli.png)
...
If you're interested in running playit 24/7 on a linux computer/server, see [How to run playit 24/7 on Linux](/host-247-with-playit)
