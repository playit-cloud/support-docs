...
![select-region](/img/new-tunnel-select-region.png)
...
![select-region](/img/playit-plus-custom-domain.png)
...
More details can be found at: [Add an external domain to playit.gg](/add-external-domain)

![external-domain](/img/external-domain.png)
