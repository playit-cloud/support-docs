...
This guide assumes you have [playit premium](https://playit.gg/account/billing/shop/premium) and have purchased a domain name on [https://namecheap.com](namecheap.com). For other Domain Registars visit [Add an external domain to playit.gg](/add-external-domain).
...
![manage domain](/img/namcheap-manage-domain.png)
...
![namecheap nameservers custom dns](/img/namecheap-nameservers-custom-dns.png)
...
![manage domain](/img/namecheap-custom-dns-playit.png)
...
![domain settings](/img/namecheap-domain-settings.png)
...
![namecheap add ns record](/img/namecheap-add-ns-record.png)
