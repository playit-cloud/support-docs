...
![papermc download](/img/papermc-download-page.png)
...
![rename paper mc file](/img/windows-rename-paper-server.png)
...
If you're not sure how to create a Batch (.bat) file, view [Creating a batch (.bat) file in windows](/creating-a-bat-file).
...
![new files generated by papermc](/img/windows-paper-mc-first-run-new-files.png)
...
![eula edit](/img/windows-eula-edit.png)
![eula highlight](/img/windows-eula-highlight.png)
![eula true](/img/windows-eula-true.png)
...
![defender allow](/img/windows-defender-allow-access.png)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/QQYRdgBL-4o" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
