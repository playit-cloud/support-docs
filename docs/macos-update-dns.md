...
![macos preference button](/img/macos-system-pref-btn.png)

Next you'll want to find the button for editing `Network Pereferences`. You can search network to find this.

![macos network preference button](/img/macos-network-settings.png)

Select the network you're using and press `Advanced`.

![macos network advanced button](/img/macos-advanced-btn.png)
...
![macos set dns](/img/macos-set-dns.png)
